...
describe('AWS S3 Integration Tests', () => {
  ...
  it('should upload and delete an image on aws s3', async () => {
    const onePixelImage = 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAA1JREFUGFdjcNrh8R8ABMQCQpaVeeEAAAAASUVORK5CYII='
